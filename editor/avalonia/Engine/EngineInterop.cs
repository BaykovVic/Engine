...
internal static class EngineInterop
{
    ...
    [DllImport(Lib)] public static extern int sky_editor_package_install(IntPtr ctx, string source);
    ...
    [DllImport(Lib)] public static extern ulong sky_editor_instantiate_prefab(IntPtr ctx, string path);
