# Спринт 1 · День 13 — выдача фич (по одной на контур)

День 13: каждый контур берёт свою **13-ю фичу** (в порядке реализации из
...
|---|---|---|
| **E1** Ядро/данные | `feature/physics-reattach` | Этап 4 (Недели 5–6, веха M3). Восстановление физики из сцены |
...
## E1 · `feature/physics-reattach`

*Этап: Этап 4 (Недели 5–6, веха M3). Восстановление физики из сцены.*
