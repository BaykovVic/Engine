...
- **B6. Рендер**: пост-процессинг (tonemapping/bloom/AA), кубмап-скайбокс и
  отражения, каскадные и точечные тени (сейчас одна directional shadow map),
  LOD, инстансинг, прозрачность с сортировкой, frustum culling.
