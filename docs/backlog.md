...
4. **Детерминизм-пакет** — стабильный порядок систем, сеемый ГПСЧ, тест
   «сценарий+сид ⇒ бит-в-бит», time scale/step из API.
5. **B1 Аудио → B3 Игровой UI → B4 Экспорт билда** — игровой трек.
